...
insert into member (designer_flag, email, premium_flag, provider, username, role, nickname, status)
values (1, 'bbbb@naver.com', 0, 'GOOGLE', 'google_5', 'ROLE_USER', '유길동', 1);
insert into member (designer_flag, email, premium_flag, provider, username, role, nickname, status)
values (1, 'bbbb@naver.com', 0, 'GOOGLE', 'google_5', 'ROLE_USER', '창길동', 1);
insert into member (designer_flag, email, premium_flag, provider, username, role, nickname, status)
values (1, 'bbbb@naver.com', 0, 'GOOGLE', 'google_5', 'ROLE_USER', '선길동', 1);

-- 선릉 6명, 건대 2명
insert into hair_designer_profile (member_id, name, description, hair_shop_name, zip_code, zip_address, latitude, longitude, detail_address, phone_number, status)
